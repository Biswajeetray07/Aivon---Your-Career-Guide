...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'GetUserRating': ApiRouteHandler<{}, ApiResponse<200, { rating: number; rank: number; percentile: number; totalUsers: number }> | ApiResponse<404, { error: string }>, never>
    ...
    'Ping': ApiRouteHandler<Record<string, unknown>, ApiResponse<200, { status: string; time: string }>, never>
    'HealthCheck': ApiRouteHandler<Record<string, unknown>, ApiResponse<200, { status: string; database: string; time: string; node_env: string }> | ApiResponse<500, { status: string; error: string }>, never>
    ...
    'AiChat': ApiRouteHandler<{ threadId?: string; problemId: string | unknown; userCode?: string; language?: string; messages: Array<unknown>; editorContext?: { lastRun?: { status: string; stderr?: string; stdout?: string; failingTest?: string } } }, ApiResponse<200, { reply: string; threadId: string }> | ApiResponse<400, { error: string }> | ApiResponse<404, { error: string }> | ApiResponse<429, { error: string }>, never>
